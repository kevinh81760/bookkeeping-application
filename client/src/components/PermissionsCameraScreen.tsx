...
interface PermissionsCameraScreenProps {
  onAllow: () => void;
  onNotNow: () => void;
}

export function PermissionsCameraScreen({ onAllow, onNotNow }: PermissionsCameraScreenProps) {
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-6 z-50">
      <div className="bg-white rounded-2xl p-6 w-full max-w-[320px] text-center">
        ...
        <div className="w-16 h-16 bg-[#E85C3C]/10 rounded-full flex items-center justify-center mx-auto mb-6">
          <Camera className="w-8 h-8 text-[#E85C3C]" />
        </div>
        ...
        <p className="text-[16px] font-medium text-[#6B7280] mb-8 leading-[1.4]">
          We need camera access to capture receipts and documents.
        </p>
